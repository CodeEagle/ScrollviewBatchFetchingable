#
# Be sure to run `pod lib lint ScrollviewBatchFetchingable.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = "ScrollviewBatchFetchingable"
  s.version          = "0.1.1"
  s.summary          = "A short description of ScrollviewBatchFetchingable."
